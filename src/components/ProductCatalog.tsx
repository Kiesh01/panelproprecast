      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-slate-600 text-base leading-relaxed">
            Engineered for maximum compressive strength, exact tolerances, and long service life. Direct supply from our &ldquo;Exit 14 Kenyatta Road&rdquo; Juja manufacturing yard.
          </p>
        </div>
