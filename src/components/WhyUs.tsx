...
export const WhyUs: React.FC = () => {
  const googleMapsUrl = 'https://maps.app.goo.gl/CMMrbTn4ufjdQSvV7';
        ...
        <div className="bg-white rounded-xl shadow-xs border border-slate-200 overflow-hidden">
          <div className="p-6 sm:p-8 bg-slate-900 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-slate-800">
            ...
            <a
              ...
              className="px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white text-xs sm:text-sm font-bold rounded-md shadow-md transition-all inline-flex items-center gap-2 cursor-pointer shrink-0"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Embedded Google Map */}
            <div className="lg:col-span-2 relative min-h-[320px] bg-slate-200">
              <iframe
            ...
            <div className="p-6 sm:p-8 bg-slate-50 border-t lg:border-t-0 lg:border-l border-slate-200 space-y-4 flex flex-col justify-center text-xs text-slate-600">
              ...
              <ul className="space-y-2.5">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-blue-600 shrink-0 mt-0.5" />
                  <span><strong>GPS Pin:</strong> <code className="bg-slate-200 px-1 py-0.5 rounded text-slate-800 font-mono">-1.083257, 36.978548</code></span>
                </li>
              </ul>
              <div className="pt-2">
                <a
                ...
                >
                  <span>Open maps.app.goo.gl link</span>
