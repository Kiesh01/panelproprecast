...
export const Footer: React.FC<FooterProps> = ({ onScrollTo, onOpenHtmlModal }) => {
  const scrollToTop = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded bg-blue-900 text-white flex items-center justify-center font-black text-base border border-blue-700">
                P
              </div>
              <span className="text-xl font-extrabold text-white tracking-tight">PanelPro</span>
              <span className="text-xl font-extrabold text-blue-400 tracking-tight">Precast</span>
            </div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li className="pt-2">
                <button
                  ...
                  className="text-blue-400 hover:text-blue-300 font-bold transition-colors cursor-pointer text-left inline-flex items-center gap-1"
                >
                  &rarr; View Updated HTML Code
                </button>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-slate-400 font-mono">
              <li>&bull; Cabro Paving Blocks (kabro.jpeg)</li>
              <li>&bull; Concrete Kerbs (concretekerbs.jpeg)</li>
              <li>&bull; Road Channels (roadchannel.jpg)</li>
              <li>&bull; Precast Culverts (culverts.jpeg)</li>
              <li>&bull; Reinforced Fence Posts (fencing-posts.jpg)</li>
              <li>&bull; Shallow Drains (shallowdrains.jpg)</li>
              <li>&bull; Precast Paving Slabs (pavingslabs.jpeg)</li>
            </ul>
          </div>
