...
import { Send, CheckCircle2, Copy, Check, Calculator, PhoneCall } from 'lucide-react';
...
Location: ${formData.location || 'Kenyatta Road / Nairobi Area'}
        ...
        <div className="bg-slate-50 border border-slate-300/80 rounded-xl p-6 sm:p-10 shadow-sm">
          ...
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <p className="text-slate-600 text-sm">
              Fill out your project specifications below. Our sales engineering team will prepare an itemized proforma quotation with transport schedules.
            </p>
          </div>
          ...
          {submitted ? (
            <div className="bg-white border border-blue-200 rounded-lg p-8 text-center space-y-4 shadow-xs">
              ...
              <p className="text-slate-600 text-sm max-w-lg mx-auto">
                Thank you, <span className="font-semibold text-slate-800">{formData.fullname}</span>. Our Kenyatta Road sales dispatch desk has received your request for <span className="font-semibold text-blue-700">{formData.product}</span>.
              </p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-md p-4 max-w-md mx-auto text-left text-xs space-y-1.5 font-mono text-slate-700">
                <div><span className="text-slate-400">Reference:</span> PR-{Math.floor(100000 + Math.random() * 900000)}</div>
              ...
              <div className="text-xs text-slate-500 pt-3 border-t border-slate-100 flex items-center justify-center gap-1.5">
                ...
                <span>Need urgent dispatch? Call sales directly at <strong>+254 700 000 000</strong></span>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    placeholder="e.g. John Doe / Apex Civil Works"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    id="location"
                    type="text"
                    placeholder="e.g. Ruiru, Kenyatta Road, Juja, Nairobi"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Yard Pickup">Self Collection from Kenyatta Road Factory Yard</option>
                  </select>
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-3.5 px-6 rounded-md bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm tracking-wide shadow-md shadow-blue-900/20 transition-all flex items-center justify-center gap-2 cursor-pointer border border-blue-500"
              >
